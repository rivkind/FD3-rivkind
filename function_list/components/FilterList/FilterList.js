...
class FilterList extends React.PureComponent {
  ...
  handleClickOutside = (e) => {
    ...
    const btnFilterWindow = document.getElementsByClassName('btn_FilterList')[0];
    const FilterWindow = document.getElementsByClassName('FilterWindow')[0];
    
    if(FilterWindow && !FilterWindow.contains(e.target) && !btnFilterWindow.contains(e.target)){
