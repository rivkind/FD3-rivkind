var ViewBlock = React.createClass({
    ...
    getInitialState: function() {
        return { 
            ...
            title: this.props.data[this.props.activeItem].title,
            descr: this.props.data[this.props.activeItem].description,
            cost: this.props.data[this.props.activeItem].cost,
        };
    },
    ...
    render: function() {
       return React.DOM.div({className:'ViewBlock'},
            ...
            (!this.props.isEditItem&&!this.props.isNewItem)?
                ...
                value: !this.props.isNewItem?this.state.title:''}),
            ),
            React.DOM.div(null,this.props.headers[1]+': ',
            (!this.props.isEditItem&&!this.props.isNewItem)?
                React.DOM.span(null,this.state.descr):
                React.DOM.input({type:'text',name:'descrInput',onChange:this.chDescr,
                value: !this.props.isNewItem?this.state.descr:''}),
            ),
